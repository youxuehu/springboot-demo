(function(){
    $.Message={
        ...
        renderHtml:function(obj){
            ...
            var strConHtml='<div><i style="display:inline-block;width:24px;height:24px;background-image:url(messageBackground.png);'+position+'vertical-align: middle;"></i><span style="margin:0 20px;display:inline-block;max-width: 300px;text-align: center;vertical-align: middle;">'+message+'</span><i style="font-style: normal;cursor: pointer;" id="messClose">X</i></div>';
